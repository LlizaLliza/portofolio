          ...
          <div className="flex items-center gap-3">
            {socialLinks.map((link) => (
              <a
                ...
                className="w-10 h-10 flex items-center justify-center rounded-xl bg-white/5 text-muted hover:text-white hover:bg-white/10 hover:border-primary/30 border border-transparent transition-all duration-300"
              >
                {link.icon}
              </a>
            ))}
